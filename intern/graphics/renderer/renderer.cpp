...
void VEng::Graphics::Renderer::Clear(const float r, const float g, const float b, const float a) const
{
    glClearColor(r, g, b, a);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
}

void VEng::Graphics::Renderer::Draw(const World::ChunkManager& chunk_manager, const Camera& camera, const VEng::GUI::Manager& gui_manager) const
{
    skybox_.Draw(camera);
...
void VEng::Graphics::Renderer::SetPolygonMode() const
{
